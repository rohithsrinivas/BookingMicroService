...
public class BookingController {
	...
	/*
	 * Using this endpoint we can get the list of all bookings that are currently
	 * available in the booking repository
	 */
	...
	/*
	 * Using this endpoint we can get the list of bookings made for a particular
	 * restaurant based on the restaurant ID
	 */
	@GetMapping(value = "/bookingsForRestaurant/{restaurantId}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<Booking>> getBookingsForRestaurant(@PathVariable("restaurantId") Integer restaurantId) {
		return new ResponseEntity<List<Booking>>(this.bookingService.getBookingsForRestaurant(restaurantId),
				HttpStatus.OK);
	}

	@GetMapping(value = "/bookingsForUser/{bookedByUserId}", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<Booking>> getBookingsForUser(@PathVariable("bookedByUserId") String bookedByUserId) {
		return new ResponseEntity<List<Booking>>(this.bookingService.getBookingsForUser(bookedByUserId), HttpStatus.OK);
	}

	/*
	 * Using this endpoint we can get the list of restaurants for a given name and
	 * required table count i.e by using the Restaurant micro service, we fetch the
	 * filtered list of restaurants
	 */
	@GetMapping(value = "/restaurants/name/{restaurantName}/{numberOfTablesRequired}", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	/*
	 * Using this endpoint we can get the list of restaurants for a given address
	 * and required table count i.e by using the Restaurant micro service, we fetch
	 * the filtered list of restaurants
	 */
	@GetMapping(value = "/restaurants/address/{address}/{numberOfTablesRequired}", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
	...
	/*
	 * this functionality is to update the number of tables in the restaurant entity
	 * when a booking is placed for a particular number of tables i.e to reduce
	 * those many number of available tables in restaurant entity
	 */
